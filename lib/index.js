...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ENGLISH_ALPHABET = void 0;
exports.ENGLISH_ALPHABET = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WORDS = exports.PREFIXES = exports.SUFFIXES = void 0;
exports.SUFFIXES = [
    'age', 'al', 'ance', 'ence',
    'dom', 'ee', 'er', 'or',
    'hood', 'ism', 'ist', 'ity',
...
exports.WORDS = [
    'apple', 'banana', 'cherry',
    'date', 'fig', 'grape', 'guava', 'honeydew', 'kiwi',
    'lemon', 'mango', 'nectarine', 'orange', 'papaya', 'pineapple',
    'quince', 'raspberry', 'strawberry', 'tangerine', 'watermelon',
    'xigua', 'yuzu', 'zucchini', 'asparagus', 'broccoli', 'cabbage',
    'carrot', 'cauliflower', 'celery', 'corn', 'cucumber', 'eggplant',
    'garlic', 'ginger', 'lettuce', 'onion', 'parsley', 'pepper',
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SUFFIXES = exports.PREFIXES = exports.WORDS = void 0;
exports.WORDS = [
    'яблоко', 'банан', 'вишня',
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generatePerson = exports.generateRandomNumber = exports.generateRandomString = exports.generateMeaningfulRuString = exports.generateMeaningfulString = exports.generateUUID = void 0;
var uuid_1 = __webpack_require__(831);
var utils_1 = __webpack_require__(336);
var persons_1 = __webpack_require__(314);
var persons_2 = __webpack_require__(412);
var tries = {
...
var generateMeaningfulString = function (length, separator) {
    return tries.en.getRandomFullString(length, separator);
};
exports.generateMeaningfulString = generateMeaningfulString;
var generateMeaningfulRuString = function (length, separator) {
    return tries.ru.getRandomFullString(length, separator);
};
exports.generateMeaningfulRuString = generateMeaningfulRuString;
var generateRandomString = function (opts) {
    if (opts === void 0) { opts = {}; }
...
var generateRandomNumber = function (opts) {
    if (opts === void 0) { opts = {}; }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CNumberOpts = exports.CStringOpts = exports.CPartNameOpts = exports.mergeInitValueWithPartialOpts = exports.isDefined = exports.isNil = exports.isEmpty = exports.generatePreparedRuTrie = exports.generatePreparedTrie = exports.shuffleArray = void 0;
var trie_1 = __webpack_require__(304);
var dictionary_1 = __webpack_require__(129);
var dictionary_2 = __webpack_require__(575);
var constants_1 = __webpack_require__(488);
/**
